...
public class OthelloTests {
    ...
    public void gameIsPlayableWorks() throws IllegalMoveException {
        MyOthelloAlgorithm solver = new MyOthelloAlgorithm(5);
        OthelloPosition pos = new OthelloPosition();
    ...
    @Test
    public void makeSureAlphaBetaIsSameAsMinMax() throws IllegalMoveException {
        OthelloPosition pos = new OthelloPosition();
        pos.initialize();
        MyOthelloAlgorithm solver = new MyOthelloAlgorithm(1);
        assertEquals(solver.alphaBeta(pos), solver.miniMax(pos, 0));
        pos = new OthelloPosition("BEEEEEEEEEEEEEEEEEEEEOEEEEEEOOEEEEEEXOEEEEEEEEEEEEEEEEEEEEEEEEEEE");
        assertEquals(solver.alphaBeta(pos), solver.miniMax(pos, 0));
    }
